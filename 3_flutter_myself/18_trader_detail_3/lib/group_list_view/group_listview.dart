...
typedef Widget ListBuilderFunction<TElement, int>(BuildContext context, TElement element, int index);
...
class _GoupListViewState<TElement, TGroup> extends State<GoupListView<TElement, TGroup, int>> {
  @override
