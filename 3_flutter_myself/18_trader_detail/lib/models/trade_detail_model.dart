...
class TradeDetailModel {
  ...
  @override
  String toString() {
    // return 'TradeDetailModel {dealTime:${this.dealTime}, typeDetail:${this.typeDetail}, inCome:${this.inCome}, outCome:${this.outCome}, availableBalance:${this.availableBalance},remian:${this.remain}';
